...
import com.company.interfaces.Animatable;
import com.company.interfaces.Comparable;
import com.company.interfaces.Countable;
import com.company.service.FileService;

public class Zootopia extends Film implements Comparable, Animatable, Countable {
    ...
    public void countKeyInBase() throws Exception {
        ...
        if(isOpen()) {
            ...
            System.out.println("Key value in Base: " + (a+1));
        } else throw new  Exception("Not connected");
    }

    @Override
    public void animation() {
        System.out.println("I'm animation film");
    }
